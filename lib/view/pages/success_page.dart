...
class SuccessPage extends StatelessWidget {
  ...
  Future<void> processingTicketOrder(BuildContext contex) async {
    contex.bloc<UserBloc>().add(Purchase(ticket.totalPrice));
    contex.bloc<TicketBloc>().add(BuyTickets(transaction.userID, ticket));
